...
import manage from './theme/common/manage';
import b2bcart from './theme/common/b2bcart';
import b2bcheckout from './theme/common/b2bcheckout';
import b2bconfirmation from './theme/common/b2bconfirmation';
import b2bportal from './theme/common/b2bportal';
import orderrequests from './theme/common/orderrequests';
import request from './theme/common/request';
